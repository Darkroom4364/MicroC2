...
pub static HIGH_THREAT_ANALYSIS_TOOLS: Lazy<Vec<String>> = Lazy::new(|| {
    vec![
...
pub static COMMON_AV_EDR_PROCESSES: Lazy<Vec<String>> = Lazy::new(|| {
    vec![
        // Windows Defender
...
pub static SUSPICIOUS_WINDOW_TITLES: Lazy<Vec<String>> = Lazy::new(|| {
    vec![
